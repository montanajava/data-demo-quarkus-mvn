...
Currently, the build is not working with the Red Hat version of Quarkus.
...
2024-11-15 05:29:54,586 ERROR [io.qua.boo.cla.PathTreeClassPathElement] (build-13) Failed to read io/vertx/mutiny/ext/web/Router.class attempting to re-open the zip file. It is likely a jar file changed on disk, you should shutdown your application: java.io.EOFException: Unexpected end of ZLIB input stream
...
[ERROR] Tests run: 1, Failures: 0, Errors: 1, Skipped: 0, Time elapsed: 4.640 s <<< FAILURE! -- in org.example.LibraryTest
[ERROR] org.example.LibraryTest.bookFindable -- Time elapsed: 0.014 s <<< ERROR!
